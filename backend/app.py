...
class ModuleRequest(BaseModel):
    ...
    apiKey: Optional[str] = Field(default=None, description="Gemini API Key from frontend")
...
async def endpoint_m2(request: ModuleRequest):
    ...
    try:
        result = run_m2(request.prompt, api_key=request.apiKey)
...
async def endpoint_m3(request: ModuleRequest):
    ...
    try:
        result = run_m3(request.prompt, api_key=request.apiKey)
        return ModuleResponse(success=True, data=result)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def endpoint_m4(request: ModuleRequest):
    ...
    try:
        result = run_m4(request.prompt, api_key=request.apiKey)
        return ModuleResponse(success=True, data=result)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def endpoint_m5(request: ModuleRequest):
    ...
    try:
        result = run_m5(request.prompt, api_key=request.apiKey)
        return ModuleResponse(success=True, data=result)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def endpoint_m6(request: ModuleRequest):
    ...
    try:
        result = run_m6(request.prompt, api_key=request.apiKey)
        return ModuleResponse(success=True, data=result)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
